...
"[project]/Documents/GitHub/evidence-hash-demo/src/app/api/users/investigators/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const investigators = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$evidence$2d$hash$2d$demo$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            role: "Investigator",
            isApproved: true,
            _id: {
                $ne: user.id
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$evidence$2d$hash$2d$demo$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(investigators, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c207990c._.js.map