...
function LoginPage() {
    ...
    let t0;
    if ($[1] !== email || $[2] !== login || $[3] !== router) {
        t0 = ({
            "LoginPage[handleLogin]": (e)=>{
                e.preventDefault();
                setLoading(true);
                let roleToAssign = "Investigator";
                if (email.includes("admin")) {
                    roleToAssign = "Admin";
                }
                if (email.includes("custodian")) {
                    roleToAssign = "Custodian";
                }
                ...
                }["LoginPage[handleLogin > setTimeout()]"], 800);
            }
    ...
    const t7 = loading ? "Authenticating..." : "Authenticate Access";
    let t8;
    if ($[12] !== loading || $[13] !== t7) {
...
*/ 
_s(LoginPage, "FYQHiVeDsfxMK0m5XHpRdKSs9XE=", false, function() {
    return [
...
//# sourceMappingURL=_fedc2417._.js.map