...
function ViewCase() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ViewCase.useEffect": ()=>{
            const fetchCase = {
                "ViewCase.useEffect.fetchCase": async ()=>{
                    try {
                        ...
                        if (response.ok) {
                            ...
                            setError(data_0.error || "Failed to load case details");
                        }
                    } catch (err) {
...
_s(ViewCase, "9h6jTSPxj3sAuWlI0YspKDuAIbc=", false, function() {
    return [
...
//# sourceMappingURL=_145aa33d._.js.map