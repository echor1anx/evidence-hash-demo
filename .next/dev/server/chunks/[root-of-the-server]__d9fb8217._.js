...
"[project]/src/app/api/custody/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$ChainOfCustody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/ChainOfCustody.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$verifyAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/verifyAuth.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    try {
        ...
        if (!globalRoles.includes(user.role) && user.role !== "Investigator") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Forbidden: You do not have permissions to modify evidence custody."
            }, {
                status: 403
            });
        }
        ...
        const caseItem = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Case$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(caseId);
        if (!caseItem) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (!evidenceExists) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Evidence hash not found in this case ledger."
            }, {
                status: 404
            });
        }
        const newLog = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$ChainOfCustody$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            caseId,
            evidenceHash,
            action,
            performedBy: user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d9fb8217._.js.map